...
<head>
  ...
  <title>CAWF| Cinematography</title>
                  ...
                  <div class="slider-content-area">
                    <div class="content">
                      <div class="inner-content">
                        <span>Why Choose Cinematography?</span>
                        <h2>The Power Behind the Camera</h2>
                        <p class="text-justify">Cinematography is more than just filming — it’s the art of storytelling
                          through motion, light, and emotion. With the rise of digital content and visual platforms,
                          skilled cinematographers are in high demand. Choosing cinematography means choosing a creative
                          career that blends technology, storytelling, and art — all through the lens of a camera.</p>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div class="col-md-12">
              <div class="divider-about-content">
                <div class="divider-content " data-aos="fade-up" data-aos-duration="1000">
                  <span>How to Start Your Cinematography Career?</span>
                  <h2 style="font-weight: bold;">Your Journey Behind the Camera Begins Here</h2>
                  <p class="text-justify">Starting your cinematography career begins with learning the art of
                    storytelling through visuals. Master the camera, understand lighting, and explore how every frame
                    can create emotion. With the right training and hands-on experience, you can turn your passion for
                    filming into a powerful, creative profession.</p>
      ...
      <section class="category-area category-style7-area">
        <div class="container">
          ...
          <div class="col-right">
            <div class="content">
              <div class="inner-content">
                <h2 class="title" style="font-weight: bold;">Create Cinematic Magic, Frame by Frame</h2>
                <p class="text-justify">Cinematography is all about turning simple moments into unforgettable visuals.
                  With every frame, you have the power to evoke emotion, tell a story, and create magic on screen. Learn
                  the skills, master the craft, and bring your cinematic vision to life—one frame at a time.</p>
            ...
            <div class="col-md-6 col-lg-5">
              <div class="divider-about-content">
                <div class="divider-content">
                  <h2 class="title">Cinematography: The Art of Visual Storytelling</h2>
                  <p class="text-justify">Cinematography is more than just shooting videos — it’s about painting stories
                    with light, motion, and emotion. Every shot, every angle, and every frame adds depth to the
                    narrative. Learn how to turn your creative vision into powerful visuals that speak louder than
                    words.</p>
                </div>
              </div>
            </div>

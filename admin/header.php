        ...
        <nav class="page-sidebar" id="sidebar">
            <div id="sidebar-collapse">
                <ul class="side-menu metismenu">
                    ...
                    <li class="mt-3">
                        <a href="javascript:;"><i class="sidebar-item-icon"><img width="35" height="35" src="https://img.icons8.com/sf-black/64/FFFFFF/gallery.png" alt="gallery"/></i>
                    ...
                    <li>
                        <a class="" href="registration_list"><i class="sidebar-item-icon"><img width="30" height="30" src="https://img.icons8.com/ios-filled/50/FFFFFF/ask-question.png" alt="ask-question"/></i>

            ...
            <div class="col-lg-12">
              <div class="page-title-content content-style2">
                ...
                <div class="bread-crumbs"><a href="index.html">Home<span class="breadcrumb-sep">></span></a><span
                    class="active">Photography</span></div>
              </div>
            </div>
          </div>
        </div>
                  ...
                  <div class="slider-content-area">
                    <div class="content">
                      <div class="inner-content">
                        ...
                        <p class="text-justify">We offer expert-led photography training with hands-on practice to help
                          you master your skills. Our personalized approach ensures you learn at your own pace, while
                          industry insights prepare you for real-world challenges. Choose us to capture moments
                          beautifully and build a strong photography career!</p>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div class="col-md-12">
              <div class="divider-about-content">
                <div class="divider-content " data-aos="fade-up" data-aos-duration="1000">
                  <span>How to Start Your Photography Career?</span>
                  <h2 style="font-weight: bold;">Kickstart Your Photography Career Today</h2>
                  <p class="text-justify">Starting your photography career begins with learning the
                    fundamentals—understanding your camera, practicing different techniques, and building a strong
                    portfolio. Gain hands-on experience by working on real projects and connecting with other
                    photographers. With dedication and creativity, you can turn your passion into a rewarding
                    profession.</p>
      ...
      <section class="category-area category-style7-area">
        <div class="container">
          ...
          <div class="col-right">
            <div class="content">
              <div class="inner-content">
                <h2 class="title" style="font-weight: bold;">Capture Moments, Create Memories</h2>
                <p class="text-justify">Photography is more than just clicking a button—it's about capturing emotions,
                  stories, and memories that last a lifetime. Learn how to turn ordinary moments into timeless visuals
                  with our expert-guided photography training. Start your journey to creating unforgettable memories
                  today.</p>
            ...
            <div class="col-md-6 col-lg-5">
              <div class="divider-about-content">
                <div class="divider-content">
                  <h2 class="title"> More Than a Click — It’s a Vision</h2>
                  <p class="text-justify">At our photography academy, we believe photography isn’t just about capturing
                    images — it’s about seeing the world differently. With expert mentors, hands-on training, and
                    real-life shooting experiences, we help you develop an eye for emotion, light, and storytelling.
                    This is where your journey from hobbyist to visual artist begins.</p>
                </div>
              </div>
            </div>
          </div>
